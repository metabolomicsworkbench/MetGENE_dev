...
<option value="Bone marrow serum">Bone marrow serum</option>
...
<option value="Cocoon shell">Cocoon shell</option>
...
<option value="Diatom cells">Diatom cells</option>
...
<option value="Infected Red Blood Cells">Infected Red Blood Cells</option>
<option value="Insect tissue">Insect tissue</option>
<option value="Interstitial fluid">Interstitial fluid</option>
<option value="Intestinal fluid">Intestinal fluid</option>
<option value="Intestine">Intestine</option>
<option value="Intracellular Granulocyte">Intracellular Granulocyte</option>
...
<option value="Merozoites">Merozoites</option>
...
<option value="Mouse tissue">Mouse tissue</option>
<option value="MSI">MSI</option>
<option value="Multiple tissues">Multiple tissues</option>
<option value="Muscle">Muscle</option>
<option value="Mycoplasma mycoides">Mycoplasma mycoides</option>
...
<option value="PJI Tissue">PJI Tissue</option>
...
<option value="Renal Medulla">Renal Medulla</option>
<option value="Retina">Retina</option>
<option value="Rhizome">Rhizome</option>
<option value="Rhizosphere">Rhizosphere</option>
<option value="Ribonucleic acid">Ribonucleic acid</option>
<option value="Roots">Roots</option>
<option value="Rumen fluid">Rumen fluid</option>
...
<option value="Soleus muscle">Soleus muscle</option>
...
<option value="Standard phosphatidylcholines">Standard phosphatidylcholines</option>
...
<option value="Tissue pool">Tissue pool</option>
<option value="Tomato">Tomato</option>
<option value="Tongue">Tongue</option>
<option value="Tritrichomonas musculis cells">Tritrichomonas musculis cells</option>
<option value="Tumor allograft">Tumor allograft</option>
<option value="Tumor cells">Tumor cells</option>
<option value="Tumor interstitial fluid">Tumor interstitial fluid</option>
<option value="Tumor tissue">Tumor tissue</option>
...
<option value="White adipose">White adipose</option>
...
<option value="Whole tumor">Whole tumor</option>
